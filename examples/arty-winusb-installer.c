/*
* arty-winusb-installer.c: Console Driver Installer for a single USB device
 ...
 */
#define DESC        "Digilent USB Device (Interface 0)"
#define VID         0x0403
#define PID         0x6010
#define INF_NAME    "arty_digilent.inf"
#define DEFAULT_DIR "art_digilent_driver"
