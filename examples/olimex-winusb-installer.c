/*
* olimex-winusb-installer.c: Console Driver Installer for a single USB device
 ...
 */
#define DESC        "Olimex OpenOCD JTAG ARM-USB-TINY-H (Interface 0)"
#define VID         0x15ba
#define PID         0x002a
#define INF_NAME    "olimex_winusb.inf"
#define DEFAULT_DIR "olimex_winusb_driver"
